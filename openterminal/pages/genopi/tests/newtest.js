      ...
      <>
        <Layout>
            <div className="hometop" style={{textAlign: 'left', paddingTop: '70px'}}>
                ...
                {[...Array(4)].map((x, i) => 
                    <div key={i} style={{ backgroundColor: '#0f0f0f', padding: '10px', borderRadius: '10px', marginBottom: '8px', border: '1px solid rgb(255, 255, 255, 0.3)', display: 'flex' }}>
                    <h2>Question<br /><input style={{ flex: '0.9' }} placeholder="Enter a question"></input></h2>
                    <h2>Answer<br /><input style={{ flex: '0.9' }} placeholder="Enter the answer"></input></h2>
                    </div>
                )}
