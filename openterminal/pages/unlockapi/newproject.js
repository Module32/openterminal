...
export default function Project() {
  ...
  if (error) return <div className={styles}><span style={{color: '#f51d1d'}}><FontAwesomeIcon icon="exclamation" /> We couldn&apos;t load your repositories.</span></div>
  if (!data) return <div className={styles}>Loading repositories...</div>
